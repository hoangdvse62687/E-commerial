...
(function () {
    ...
    var defaults = {
        ...
        errorClass: "error",               // single class for error message and element
    ...
    var utils = (function () {
        ...
        return {
            ...
            isValidatable: function (o) {
                return o != undefined && o.rules && o.isValid && o.isModified;
            },
    ...
    ko.validation.rules['min'] = {
        ...
        message: 'Nhập một giá trị lớn hơn hoặc bằng {0}.'
    };
    ...
    ko.validation.rules['max'] = {
        ...
        message: 'Nhập một giá trị nhỏ hơn hoặc bằng {0}.'
    };
    ...
    ko.validation.rules['pattern'] = {
        ...
        message: 'Xin hãy kiểm tra giá trị.'
    };
    ...
    ko.validation.rules['phoneUS'] = {
        ...
        message: 'Xin hãy nhập số hợp lệ'
    };
    ...
    ko.validation.rules['notEqual'] = {
        ...
        message: 'Xin hãy chọn một giá trị khác.'
    };
    ...
    ko.bindingHandlers['currencyNumberFormat'] = (function () {
        return {
            init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ko.utils.registerEventHandler(element, 'keyup', function (event) {
                    var observable = valueAccessor();
                    observable(formatNumberInput(element.value));
    ...
    ko.bindingHandlers['urlFormat'] = (function () {
        return {
            init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ko.utils.registerEventHandler(element, 'keyup', function (event) {
                    var observable = valueAccessor();
                    observable(formatUrlInput(element.value));
                    observable.notifySubscribers(observable());
                });
            },
            update: function (element, valueAccessor, allBindingsAccessor) {
